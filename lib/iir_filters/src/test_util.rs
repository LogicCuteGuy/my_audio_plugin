...
pub(crate) mod test {
    ...
    impl Sos {
        pub fn assert_approx_equal_to(&self, other: &Sos, eps: f32) {
    ...
    impl ZPKCoeffs {
        pub fn assert_approx_equal_to(&self, other: &ZPKCoeffs, eps: f32) {
        ...
        pub fn assert_approx_equal_to_with_sort(&self, other: &ZPKCoeffs, eps: f32, z_keys: &[Keys], p_keys: &[Keys]) {
            assert_eq!(self.z.len(), other.z.len(), "Number of zeroes are not equal.");
            assert_eq!(self.p.len(), other.p.len(), "Number of poles are not equal.");
    ...
    impl BACoeffs {
        pub fn assert_approx_equal_to(&self, other: &BACoeffs, eps: f32) {
    ...
    pub fn load_test_file(file_name: &str) -> Result<(Vec<f32>, Vec<f32>), Error> {

...
pub fn hz_cal_tlh(note: u8, note_pitch: i8, pitch_tune_hz: &mut f32, low_pass: &mut f32, high_pass: &mut f32, hz_center: f32, hz_tuning: f32) {
    ...
    *low_pass = ((hz_tuning * 2.0_f32.powf(((note as i8) - 68 + note_pitch) as f32 / 12.0)) + &tune_note_hz) / 2.0;
    *high_pass = ((hz_tuning * 2.0_f32.powf(((note as i8) - 70 + note_pitch) as f32 / 12.0)) + &tune_note_hz) / 2.0;
}